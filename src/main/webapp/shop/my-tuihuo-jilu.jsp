...
<header id="pc-header">
    <div class="pc-header-nav">
        <div class="pc-header-con">
            <div class="fl pc-header-link" >您好！，欢迎来dangdang <a href="login.html" target="_blank">请登录</a> <a href="register.html" target="_blank"> 免费注册</a></div>
    ...
    <div class="yHeader">
        ...
        <div class="yNavIndex">
            <ul class="yMenuIndex" style="margin-left:0">
                <li style="background:#d1201e"><a href="" target="_blank">dangdang首页</a></li>
    ...
    <div class="member-center clearfix">
        ...
        <div class="member-right fr">
            <div class="member-head">
                ...
                <div style="margin-top:8px" class="member-about fr"><input placeholder="商品名称/商品编号/订单编号" type="text"></div>
            </div>
